USE [SIntegralH]
GO
/****** Object:  StoredProcedure [dbo].[LAB_ExportaResultadosValidados]    Script Date: 09/11/2020 10:54:29 ******/
SET ANSI_NULLS ON
GO
...
--and ( CONVERT(varchar(6), fechaValida, 112) = '201412' or CONVERT(varchar(6), fechaValidaObservacion, 112) ='201412' )

--and ( CONVERT(varchar(8), fechaValida, 112) <> '19000101' or CONVERT(varchar(8), fechaValidaObservacion, 112) <> '19000101' )
--and ( P.idPaciente = 100265 )
