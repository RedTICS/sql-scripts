USE [SIntegralH]
GO
/****** Object:  StoredProcedure [dbo].[LAB_ExportaResultadosValidados]    Script Date: 09/11/2020 12:17:17 ******/
SET ANSI_NULLS ON
GO
...
-- and (CONVERT(VARCHAR(6), fechaValida, 112) = '201903' or CONVERT(VARCHAR(6), fechaValidaObservacion, 112) = '201903')
