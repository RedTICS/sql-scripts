USE [SIntegralH]
GO
/****** Object:  StoredProcedure [dbo].[LAB_ExportaResultadosValidados]    Script Date: 09/11/2020 10:33:54 ******/
SET ANSI_NULLS ON
GO
...
--and (CONVERT(VARCHAR(6), fechaValida, 112) = '201408' or CONVERT(VARCHAR(6), fechaValidaObservacion, 112) = '201408')
