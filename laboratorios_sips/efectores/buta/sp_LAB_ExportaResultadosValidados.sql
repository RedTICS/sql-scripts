USE [SIPSButa]
GO
/****** Object:  StoredProcedure [dbo].[LAB_ExportaResultadosValidados]    Script Date: 09/11/2020 11:04:24 ******/
SET ANSI_NULLS ON
GO
...
--and ((CONVERT(varchar, fechaValida, 112) between '20160720' and '20160727' ) or  CONVERT(varchar, fechaValidaObservacion, 112) between '20160720' and '20160727' )
...
SELECT DISTINCT P.idProtocolo, P.idEfector, Pac.apellido, Pac.nombre, P.edad, 
			 ...
			 P.observacionesResultados, P.baja
